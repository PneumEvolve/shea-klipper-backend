...
class FireflyRoom(Base):
    __tablename__ = "firefly_rooms"
    ...
    map_seed    = Column(Integer, nullable=False)
...
class SlalomRoom(Base):
 ...
 # ─── Stronghold Game ──────────────────────────────────────────────────────────
# Add this at the bottom of models.py (after SlalomRoom)
 
class StrongholdRoom(Base):
    __tablename__ = "stronghold_rooms"
...
class InkRunRoom(Base):
    __tablename__ = "inkrun_rooms"
