"""baseline (full create)

Revision ID: 0bbd73b185e2
Revises: 
Create Date: 2025-08-17 16:49:39.419170
...
def upgrade() -> None:
    ...
    # Add the cross-table FKs now that both tables exist
    op.create_foreign_key(
        'fk_solutions_problem_id',
    ...
    op.create_foreign_key(
        'fk_problems_accepted_solution_id',
        source_table='problems',
        referent_table='solutions',
        local_cols=['accepted_solution_id'],
        remote_cols=['id'],
        deferrable=True, initially='DEFERRED'
    )
